...
- escalation: 사용자가 **명시적으로** 상담원 연결을 요청하거나 화남/불만을 표시한 경우만 ("상담원 바꿔줘요", "사람이랑 통화하고 싶어요", "너무 답답해요")
  → 주의: 같은 정보를 다시 묻는 발화 (예: 직전 답을 못 들은 후 재질의) 는 escalation 이 아닙니다. 원래 카테고리 (faq/task) 로 다시 분류하세요.

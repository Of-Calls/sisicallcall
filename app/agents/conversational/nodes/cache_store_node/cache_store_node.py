...
#
# 저장 금지 7조건 (CLAUDE.md + 의미 fallback 확장):
...
# - response_path == "auth" (2026-04-30 추가 — 인증 응답은 컨텍스트 의존성 강해
#   통화 간 / turn 간 crosstalk 위험. logs/2026-04-30/server_114028.log Turn 6
#   사례: 이전 통화의 auth 응답이 운영시간 질문에 cosine 0.9554 hit 사고)
# - reviewer_verdict == "revise" (Reviewer 가 수정한 응답)

logger = get_logger(__name__)
_cache_service = SemanticCacheService()

_BLOCKED_RESPONSE_PATHS = {"escalation", "cache", "clarify", "repeat", "auth"}
